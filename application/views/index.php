			...
			<div class="row wrap">
				<div class="col-md-12 gallery">
						<div class="camera_wrap camera_white_skin" id="camera_wrap_1">
							<div data-thumb="" data-src="<?php echo base_url('assets/images/slides/blank.gif')?>">
								<div class="img-responsive camera_caption fadeFromBottom">
									<h2 style="font-size: 70px;">Votre projet c'est notre Métier.</h2>
								</div>
							</div>
							<div data-thumb="" data-src="<?php echo base_url('assets/images/slides/blank.gif')?>">
								<div class="img-responsive camera_caption fadeFromBottom">
									<h2 style="font-size: 70px;">Travail en équipe dynamique.</h2>
								</div>
							</div>
							<div data-thumb="" data-src="<?php echo base_url('assets/images/slides/blank.gif')?>">
								<div class="img-responsive camera_caption fadeFromBottom">
									<h2 style="font-size: 70px;">Réalisation Application Web / Mobile / Desktop</h2>
								</div>
							</div>
						</div><!-- #camera_wrap_1 -->
				</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 centPic">
					<img class="img-responsive"  src="<?php echo base_url('assets/images/bizPic.png')?>"/>
				</div>
			</div>
		</div>
    </div>
		...
		<div class="container">
			<div class="row team">
				<div class="col-md-4 b1">
						<img class="img-responsive" src="<?php echo base_url('assets/images/picTeam/picT1.png')?>">
						<h4>Tom Simpson</h4>
						<h5>CEO</h5>
				...
				<div class="col-md-4">
						<img class="img-responsive" src="<?php echo base_url('assets/images/picTeam/picT2.png')?>">
						<h4>John Doe</h4>
				...
				<div class="col-md-4 b3">
						<img class="img-responsive" src="<?php echo base_url('assets/images/picTeam/picT3.png')?>">
						<h4>Anna White</h4>
						<h5>Developer</h5>
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit<br/> quisque tempus ac eget diam et laoreet phasellus ut nisi id leo molestie. adipiscing vitae vel quam proin eget mauris eget.</p>
						<ul>
		...
		<div style="position: relative;">
			...
			<div class="container">
				<div class="row about">
					<div class="col-md-6">
						<div class="about1">
						<img class="pic1Ab" src="<?php echo base_url('assets/images/picAbout/aboutP1.png')?>">
					...
					<div class="col-md-6">
						<div class="about2">
						<img class="pic2Ab" src="<?php echo base_url('assets/images/picAbout/aboutP2.png')?>">
			...
			<div class="container">
				<div class="row about">
					<div class="col-md-6">
						<div class="about1">
						<img class="pic1Ab" src="<?php echo base_url('assets/images/picAbout/aboutP3.png')?>">
					...
					<div class="col-md-6">
						<div class="about2">
						<img class="pic2Ab" src="<?php echo base_url('assets/images/picAbout/aboutP4.png')?>">
		...
		<div class="row">
			...
			<div class="portfolio_block columns3   pretty" data-animated="fadeIn">
					<div class="element col-sm-4   gall branding">
						<a class="plS" href="<?php echo base_url('assets/images/prettyPhotoImages/pic1.jpg')?>" rel="prettyPhoto[gallery2]">
							<img class="img-responsive picsGall" src="<?php echo base_url('assets/images/prettyPhotoImages/thumb_pic1.jpg')?>" alt="pic1 Gallery"/>
						</a>
					...
					<div class="element col-sm-4  gall branding">
						<a class="plS" href="<?php echo base_url('assets/images/prettyPhotoImages/pic2.jpg')?>" rel="prettyPhoto[gallery2]">
							<img class="img-responsive picsGall" src="<?php echo base_url('assets/images/prettyPhotoImages/thumb_pic2.jpg')?>" alt="pic2 Gallery"/>
						</a>
					...
					<div class="element col-sm-4  gall web">
						<a class="plS" href="<?php echo base_url('assets/images/prettyPhotoImages/pic3.jpg')?>" rel="prettyPhoto[gallery2]">
							<img class="img-responsive picsGall" src="<?php echo base_url('assets/images/prettyPhotoImages/thumb_pic3.jpg')?>" alt="pic3 Gallery"/>
						</a>
						<div class="view project_descr ">
					...
					<div class="element col-sm-4  gall  text_styles">
						<a class="plS" href="<?php echo base_url('assets/images/prettyPhotoImages/pic4.jpg')?>" rel="prettyPhoto[gallery2]">
							<img class="img-responsive picsGall" src="<?php echo base_url('assets/images/prettyPhotoImages/thumb_pic4.jpg')?>" alt="pic1 Gallery"/>
						</a>
						<div class="view project_descr ">
					...
					<div class="element col-sm-4  gall  web">
						<a class="plS" href="<?php echo base_url('assets/images/prettyPhotoImages/pic5.jpg')?>" rel="prettyPhoto[gallery2]">
							<img class="img-responsive picsGall" src="<?php echo base_url('assets/images/prettyPhotoImages/thumb_pic5.jpg')?>" alt="pic1 Gallery"/>
						</a>
						<div class="view project_descr center">
					...
					<div class="element col-sm-4  gall  polygraphy">
						<a class="plS" href="<?php echo base_url('assets/images/prettyPhotoImages/pic6.jpg')?>" rel="prettyPhoto[gallery2]">
							<img class="img-responsive picsGall" src="<?php echo base_url('assets/images/prettyPhotoImages/thumb_pic6.jpg')?>" alt="pic1 Gallery"/>
						</a>
						<div class="view project_descr ">
					...
					<div class="element col-sm-4   gall branding">
						<a class="plS" href="<?php echo base_url('assets/images/prettyPhotoImages/pic7.jpg')?>" rel="prettyPhoto[gallery2]">
							<img class="img-responsive picsGall" src="<?php echo base_url('assets/images/prettyPhotoImages/thumb_pic7.jpg')?>" alt="pic1 Gallery"/>
						</a>
						<div class="view project_descr ">
					...
					<div class="element col-sm-4  gall text_styles">
						<a class="plS" href="<?php echo base_url('assets/images/prettyPhotoImages/pic8.jpg')?>" rel="prettyPhoto[gallery2]">
							<img class="img-responsive picsGall" src="<?php echo base_url('assets/images/prettyPhotoImages/thumb_pic8.jpg')?>" alt="pic1 Gallery"/>
						</a>
						<div class="view project_descr ">
					...
					<div class="element col-sm-4  gall polygraphy">
						<a class="plS" href="<?php echo base_url('assets/images/prettyPhotoImages/pic9.jpg')?>" rel="prettyPhoto[gallery2]">
							<img class="img-responsive picsGall" src="<?php echo base_url('assets/images/prettyPhotoImages/thumb_pic9.jpg')?>" alt="pic1 Gallery"/>
						</a>
						<div class="view project_descr ">
			...
			<script type="text/javascript">
				jQuery(window).load(function(){
					items_set = [
						...
						{category : 'branding', lika_count : '77', view_count : '234', src : '<?php echo base_url('assets/images/prettyPhotoImages/pic9.jpg')?>', title : 'Foil Mini Badges', content : '' },

						{category : 'polygraphy', lika_count : '45', view_count : '100', src : '<?php echo base_url('assets/images/prettyPhotoImages/pic7.jpg')?>', title : 'Darko – Business Card Mock Up', content : '' },

						{category : 'text_styles', lika_count : '22', view_count : '140', src : '<?php echo base_url('assets/images/prettyPhotoImages/pic8.jpg')?>', title : 'Woody Poster Text Effect', content : '' }
    ...
    <div id="news">
    	<div class="line4">
			<div class="container">
				<div class="row Ama">
					<div class="col-md-12">
					<h3>Quoi de neuf chez Innovation ?</h3>
					<p><-- Les nouvelles de notre site du dernière info --></p>
					</div>
				</div>
			</div>
		</div>
		<div class="container">
				<div class="row news">
					...
					<img class="img-responsive picsGall" src="<?php echo base_url('assets/images/picNews/news1.jpg')?>"/>
					...
					<img class="img-responsive picsGall" src="<?php echo base_url('assets/images/picNews/news2.jpg')?>"/>
			...
			<div class="container">
				<div class="row news2 news">
					<div class="col-md-6 text-left">
					<img class="img-responsive picsGall" src="<?php echo base_url('assets/images/picNews/news3.jpg')?>"/>
					<h3><a href="#">Lorem Ipsum Dolor sit Amet Pelenntesque Sodales!</a></h3>
					<ul>
						<li><i class="fa fa-calendar"></i>April 25, 2014</li>
						<li><a href="#"><i class="fa fa-folder-open"></i>Staff</a></li>
					...
					<div class="col-md-6 text-right">
					<img class="img-responsive picsGall" src="<?php echo base_url('assets/images/picNews/news4.jpg')?>"/>
					<h3><a href="#">Nam in Nisl id Ipsum Feugiat Posuere ut sit Amet Sem</a></h3>
					<ul>
						<li><i class="fa fa-calendar"></i>April 25, 2014</li>
						<li><a href="#"><i class="fa fa-folder-open"></i>Staff</a></li>
			...
			<div class="container">
				<div class="row news2 nouveaute">
					<div class="col-md-6 text-left">
					<img class="img-responsive picsGall" src="<?php echo base_url('assets/images/picNews/news5.jpg')?>"/>
					<h3 ><a href="#">Lorem Ipsum Dolor sit Amet Pelenntesque Sodales!</a></h3>
					<ul>
						<li><i class="fa fa-calendar"></i>April 25, 2014</li>
						<li><a href="#"><i class="fa fa-folder-open"></i>Staff</a></li>
					...
					<div class="col-md-6 text-right">
					<img class="img-responsive picsGall" src="<?php echo base_url('assets/images/picNews/news6.jpg')?>"/>
					<h3><a href="#">Nam in Nisl id Ipsum Feugiat Posuere ut sit Amet Sem</a></h3>
					<ul>
						<li><i class="fa fa-calendar"></i>April 25, 2014</li>
						<li><a href="#"><i class="fa fa-folder-open"></i>Staff</a></li>
    ...
    <div id="contact">
    	<div class="line5">					
			<div class="container">
				<div class="row Ama">
					<div class="col-md-12">
					<h3>Vous avez des Questions? S'il vous plaît écriver nous!</h3>
					<p>Ici, ci-dessous</p>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-9 col-xs-12 forma">
					<form>
						<input type="text" class="col-md-6 col-xs-12 name" name='name' placeholder='Nom *'/>
						<input type="text" class="col-md-6 col-xs-12 Email" name='Email' placeholder='Email *'/>
						<input type="text" class="col-md-12 col-xs-12 Subject" name='Subject' placeholder='Sujet *'/>
						<textarea type="text" class="col-md-12 col-xs-12 Message" name='Message' placeholder='Message *'></textarea>
						<div class="cBtn col-xs-12">
							<ul>
								<li class="clear"><a href="#"><i class="fa fa-times"></i>Effacer</a></li>
								<li class="send"><a href="#"><i class="fa fa-share"></i>Envoyer</a></li>
							</ul>
						</div>
					</form>
				</div>
